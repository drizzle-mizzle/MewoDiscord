...
ffmpeg ставится пакетом в runtime-стадии, yt-dlp скачивается статическим бинарём релиза
в build-стадии и копируется дальше — так в runtime-образ не едут ни python, ни curl.
