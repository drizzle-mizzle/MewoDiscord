...
/// <summary>
/// Подтягивает медиа из постов X, ссылки на которые появились в чате. Родное превью X
/// заменяет видео и гифку неподвижным кадром, а картинок показывает не больше четырёх —
/// поэтому отвечаем своим контейнером с файлами, а превью гасим.
