...
/// Узнаём только YouTube, а не «любой из сайтов yt-dlp»: такую регулярку не удержать
/// верной, а промахиваться она будет молча.
/// </summary>
public static partial class YoutubeLinks
{
    ...
    /// опции), не от file:// и не от ссылки на плейлист.
    /// </summary>
