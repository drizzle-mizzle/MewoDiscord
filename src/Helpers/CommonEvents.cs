...
/// в котором оно случилось. Текст приходит уже готовым для общего чата — у журнала
/// своя формулировка, и оба набора живут в messages.ini (ключи с суффиксом Common).
/// Разводит их контекст: журнал сидит в треде, названном по каналу, а в общем чате
/// канал надо называть — иначе непонятно, куда идти.
/// </summary>
