...
public class ChatGptSession
{
    ...
    /// Картинки лежат в истории base64-строками и уходят в запрос при каждом обмене:
    /// без чистки пара фотографий раздула бы и запрос, и json состояния. О чём шла речь,
    /// история помнит и без них — служебная строка «приложил изображения» остаётся.
    /// </summary>
