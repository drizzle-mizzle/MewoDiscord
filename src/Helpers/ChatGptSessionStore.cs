...
public static class ChatGptSessionStore
{
    ...
    public sealed class SessionEntry
    {
        ...
        /// в эту ветку, пусть и не в её конец. Кольцо на <see cref="RecentMessagesKept"/>
        /// записей.
        /// </summary>
    ...
    public static void Rebind(SessionEntry entry, ulong newLastMessageId)
    {
        lock (_lock)
        {
            // Сессию могло вытеснить, пока её хит выполнялся: метка у неё старая, и она
            // законная кандидатка на вылет. Сохранять вытесненную нельзя — её файл
            // состояния воскрес бы навсегда
    ...
    /// или одному из недавних. Отличает реплай в старую ветку сессии, который игнорируется,
    /// от реплая на любое другое сообщение бота.
    /// </summary>
    ...
    /// заставших сессию за работой, и сами по себе не исчезают.
    /// </summary>
