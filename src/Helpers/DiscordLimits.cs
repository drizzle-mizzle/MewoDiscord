...
/// назвать человеку. Правило одно на всех, поэтому и живёт в одном месте.
/// </summary>
internal static class DiscordLimits
{
    /// <summary>
    /// Размер человеку: мегабайты с одним знаком.
    /// </summary>
    ...
    /// <summary>
    /// Имя файла из ссылки; запасное имя задаёт вызывающий.
    /// </summary>
