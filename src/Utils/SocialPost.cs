...
/// Логин автора лежит отдельно от имени: подписью ссылки идёт он — логин из латиницы
/// и цифр рисуется всегда, а имя бывает и из одних эмодзи, с которыми Discord скрытую
/// ссылку не рисует вовсе.
/// </summary>
...
public static class SocialMediaHttp
{
    ...
    /// <summary>
    /// Потолок на всё скачивание медиа целиком, включая чтение тела.
    /// </summary>
