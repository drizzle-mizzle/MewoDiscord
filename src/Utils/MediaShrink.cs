...
/// <summary>
/// Расчёт параметров пережатия под заданный размер. Цель считается напрямую из размера
/// и длительности, а следующий круг корректируется по факту предыдущего: слепой шаг
/// «минус двадцать процентов» стоил бы лишнего перекодирования на каждом промахе.
/// Все методы чистые: ни файлов, ни процессов, только числа.
/// </summary>
